...
const translations = {
  ko: {
    ...
    "pricing.free.desc": "시작용 무료 플랜",
    "pricing.free.f1": "월 전략 2개",
    "pricing.free.f2": "월 백테스트 3회",
    "pricing.free.cta": "무료로 시작",
    "pricing.pro.desc": "진지한 트레이더용",
    "pricing.pro.f1": "월 전략 20개",
    "pricing.pro.f2": "심층 AI 코칭",
    "pricing.pro.f3": "1년치 백테스트",
    "pricing.pro.cta": "Pro 시작하기",
    "pricing.elite.desc": "최상위 기능 전부",
    "pricing.elite.f1": "전략 무제한",
    "pricing.elite.f2": "실시간 전략 알림",
    "pricing.elite.f3": "전략 스크립트 내보내기",
    "pricing.elite.cta": "Elite 시작하기",
  ...
  en: {
    ...
    "pricing.free.f1": "2 strategies/month",
    "pricing.free.f2": "3 backtests/month",
    "pricing.free.cta": "Start Free",
    "pricing.pro.desc": "For serious traders",
    "pricing.pro.f1": "20 strategies/month",
    "pricing.pro.f2": "Deep AI coaching",
    "pricing.pro.f3": "1-year backtest",
    "pricing.pro.cta": "Start Pro",
    "pricing.elite.desc": "Everything unlocked",
    "pricing.elite.f1": "Unlimited strategies",
    "pricing.elite.f2": "Real-time alerts",
    "pricing.elite.f3": "Strategy script export",
    "pricing.elite.cta": "Start Elite",
